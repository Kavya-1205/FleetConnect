  ...
  void submitIssue() async {
    ...
    try {
      await ApiService.addIssue(
        ...
        date: selectedDate,
        odoEntry: int.parse(odoController.text.trim()),
      );
    ...
    return Scaffold(
      body: Container(
        ...
        child: SafeArea(
          child: Column(
            children: [
              // ── Custom AppBar — same style as Trip/Fuel/Repair ──
              Padding(
              ...
              Expanded(
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      const Text(
                        "Report a vehicle observation or issue for fleet review.",
